...
QT_MOC_LITERAL(1, 10, 12), // "foundDevices"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 11), // "nDeviceName"
QT_MOC_LITERAL(4, 36, 12), // "errorOccured"
QT_MOC_LITERAL(5, 49, 8) // "errorMsg"

    },
    "HikCamera\0foundDevices\0\0nDeviceName\0"
    "errorOccured\0errorMsg"
};
...
void HikCamera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->foundDevices((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        ...
        {
            using _t = void (HikCamera::*)(QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HikCamera::foundDevices)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HikCamera::errorOccured)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HikCamera::foundDevices(QStringList _t1)
{
...
// SIGNAL 1
void HikCamera::errorOccured(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
