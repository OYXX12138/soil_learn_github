...
#include <memory>
#include "../../src/core/serialworker.h"
...
QT_MOC_LITERAL(1, 13, 13), // "statusChanges"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 9), // "connected"
QT_MOC_LITERAL(4, 38, 7), // "message"
QT_MOC_LITERAL(5, 46, 12), // "dataReceived"
QT_MOC_LITERAL(6, 59, 10), // "SensorData"
QT_MOC_LITERAL(7, 70, 4), // "data"
QT_MOC_LITERAL(8, 75, 13), // "errorOccurred"
QT_MOC_LITERAL(9, 89, 8), // "errorMsg"
QT_MOC_LITERAL(10, 98, 8), // "openPort"
QT_MOC_LITERAL(11, 107, 8), // "portName"
QT_MOC_LITERAL(12, 116, 9), // "closePort"
QT_MOC_LITERAL(13, 126, 11) // "onReadyRead"

    },
    "SerialWorker\0statusChanges\0\0connected\0"
    "message\0dataReceived\0SensorData\0data\0"
    "errorOccurred\0errorMsg\0openPort\0"
    "portName\0closePort\0onReadyRead"
};
...
void SerialWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->statusChanges((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->dataReceived((*reinterpret_cast< SensorData(*)>(_a[1]))); break;
        case 2: _t->errorOccurred((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->openPort((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        case 1:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< SensorData >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (SerialWorker::*)(bool , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialWorker::statusChanges)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SerialWorker::*)(SensorData );
...
// SIGNAL 0
void SerialWorker::statusChanges(bool _t1, QString _t2)
{
...
// SIGNAL 1
void SerialWorker::dataReceived(SensorData _t1)
{
...
// SIGNAL 2
void SerialWorker::errorOccurred(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
